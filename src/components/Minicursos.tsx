...
const minicursosData: Minicurso[] = [
  ...
  },
  {
    ...
    descricao: "Crie, do zero, uma página que consome uma API pública de jogos: listagem, busca e detalhes. Passo a passo acessível para iniciantes, com boas práticas e integração real com HTTP.",
  ...
  },
  {
    ...
    imagem: "/imagens/Interno (Gabriel Canela) - A importância da privacidade na Internet e a Regulamentação do Uso de IA nos ambientes Virtuais.jpg",
    descricao: "Entenda por que a privacidade importa, boas práticas para navegar com segurança e um panorama da regulamentação do uso de IA em ambientes virtuais.",
