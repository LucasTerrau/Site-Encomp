      ...
      <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center">
                <div className="relative w-full max-w-md">
                  <img src="/imagens/Logo.png" alt="ENCOMP Logo" className="w-full" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 pt-16 border-t border-encomp-green/20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center">
              <div className="relative w-full max-w-md">
                <div className="absolute -inset-4 bg-gradient-to-r from-encomp-light-green/20 to-encomp-green/20 rounded-lg blur-lg" />
                <img
