              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-300">
                    O Encontro de Computação (ENCOMP) surgiu em 2015 como uma
                    iniciativa dos estudantes e professores do curso Bacharelado
                    em Ciência da Computação do IFSULDEMINAS - Campus Passos,
                    com o objetivo de aproximar a comunidade acadêmica do
                    mercado de trabalho e das tendências tecnológicas.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-300">
                    Ao longo dos anos, o evento cresceu e se consolidou como uma
                    das principais conferências de tecnologia da região,
                    atraindo participantes de diversas instituições e
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-300">
                    Para 2025, o ENCOMP chega à sua 11ª edição com uma
                    programação especial, trazendo temas inovadores como
                    Inteligência Artificial, Cloud Computing, Edição de Vídeo e
                    muito mais.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                ...
                Minas Gerais - Campus Passos é referência na área de computação,
                com professores dedicados e estrutura moderna. Fiel à sua
                tradição como anfitrião do ENCOMP, segue oferecendo estrutura,
                tecnologia e acolhimento aos participantes.
              </p>
