  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scrolled
          ? "bg-encomp-dark/90 backdrop-blur shadow-md shadow-encomp-green/10"
          : "bg-transparent"
      }`}
    >
      <div className="container mx-auto flex justify-between items-center py-4 px-4 md:px-8">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link
            ...
            smooth={true}
            duration={500}
            className="text-sm text-white hover:text-encomp-green transition-colors cursor-pointer"
          >
            Home
          </Link>
            ...
            <DropdownMenuContent className="bg-encomp-dark/95 backdrop-blur border-encomp-green/20">
              <DropdownMenuItem asChild>
                <button
                  ...
                  className="w-full text-left text-white hover:text-encomp-green hover:bg-encomp-green/10 cursor-pointer"
                >
                  História
                </button>
              </DropdownMenuItem>
              ...
              <DropdownMenuItem asChild>
                <button
                  onClick={() => scrollToSection("minicursos")}
                  className="w-full text-left text-white hover:text-encomp-green hover:bg-encomp-green/10 cursor-pointer"
                >
                  Minicursos
                </button>
          ...
          <DropdownMenu
            ...
            onOpenChange={setIsInfoDropdownOpen}
          >
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-1 text-sm text-white hover:text-encomp-green transition-colors cursor-pointer">
                Informações
        ...
        {isOpen && (
          <div className="absolute top-full left-0 w-full bg-encomp-dark/95 backdrop-blur flex flex-col items-center py-4 shadow-lg md:hidden">
            <Link
              ...
              smooth={true}
              duration={500}
              className="my-2 text-white hover:text-encomp-green transition-colors cursor-pointer"
            >
              Home
            </Link>
            <Link
