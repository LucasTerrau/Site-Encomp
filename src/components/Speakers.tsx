...
export const speakersData = [
  {
    ...
    description: 'Algoritmos de destruição em massa: Big Techs, Big Data, IA e seus aspectos socioambientais.',
    date: '03 de Novembro',
    time: '08:30',
  ...
  },
  {
    ...
    description: 'Do Campus ao Mundo: Navegando décadas de transformações de carreira.',
    date: '04 de Novembro',
    time: '08:30',
    modalidade: 'Presencial',
    local: 'Auditório',
          ...
          {speakersData.map((speaker, index) => (
            <div
              ...
              className={`bg-encomp-darkGray h-full p-6 rounded-lg shadow-md flex flex-col transition-all duration-500 transform hover:scale-105 hover:shadow-lg ${
                highlightedSpeaker === speaker.id ? 'animate-highlight border-2 border-encomp-green/70' : 'border border-encomp-green/20'
              }`}
