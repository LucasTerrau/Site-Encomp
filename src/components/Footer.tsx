      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              O maior evento de computação do Sul de Minas Gerais. Palestras,
              minicursos, campeonato de League of Legends e muito mais!
            </p>
        ...
        <div className="border-t border-encomp-green/20 mt-8 pt-8 text-center text-gray-500">
          <p className="mt-2 text-sm mb-2">
            Desenvolvido com 💚 pelos alunos do 6º período do Curso Bacharelado
            em Ciência da Computação
          </p>
          <p>
            © 2025 ENCOMP - Encontro de Computação IFSULDEMINAS. Todos os
            direitos reservados.
          </p>
        </div>
      </div>
