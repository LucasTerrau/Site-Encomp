...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col justify-center items-center pt-20 pb-16 px-4 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80')] bg-cover bg-center opacity-10" />

      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-1/3 h-1/3 border border-encomp-green/20 rounded-full top-1/4 left-1/4 animate-pulse" />
        <div className="absolute w-1/2 h-1/2 border border-encomp-green/10 rounded-full top-1/4 right-1/4 animate-pulse" style={{ animationDelay: "0.5s" }} />
        <div className="absolute w-80 h-80 bg-encomp-green/5 blur-3xl rounded-full top-1/3 left-1/2 transform -translate-x-1/2" />
      </div>

      <div className="container mx-auto text-center z-10">
        <div className="mb-6 flex justify-center">
          <div className="relative w-40 h-40 md:w-56 md:h-56 animate-float">
            <img src="/imagens/Logo.png" alt="ENCOMP 2025 Logo" className="w-full h-full object-contain" />
          </div>
        </div>
