...
const CollaboratorCard = ({ name, logo }: Collaborator) => (
  <div
  ...
  >
    <div className="p-6 flex flex-col items-center justify-center">
      <div className="w-full h-40 md:h-48 flex items-center justify-center rounded-2xl border border-encomp-green/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.03))] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] overflow-hidden">
        <img
          src={logo}
          alt={`Logo de ${name}`}
      ...
      <p className="mt-4 text-center text-base font-semibold text-white/90">{name}</p>
    </div>
  </div>
);
    ...
    <section className="relative overflow-hidden py-20 bg-encomp-black">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <header className="mb-12 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-2">Nossos Colaboradores</h2>
          <p className="text-encomp-green/80 text-lg">Agradecemos a cada colaborador pelo apoio e confiança.</p>
        </header>
